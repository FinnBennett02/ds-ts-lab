...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, Intersection } from "./myTypes";
...
function secureFindFriends(friends: Friend[],criteria: (f: Friend) => boolean): SecureFriendContact[] {
 ...
 // console.log(result)
  ...
  function intersection(friends: Friend[],colleagues: Colleague[]): Intersection[] {
